...
link = "http://13.124.80.116:8000/users/"
...
link = "http://13.124.80.116:8000/debts/"
...
debts_json = get_json_or_error("http://13.124.80.116:8000/debts/", admname, admpwd)
if len(debts_json) != len(debts):
    print("ERROR: GET http://13.124.80.116:8000/debts/ has more or less items than debts")
    exit(1)
